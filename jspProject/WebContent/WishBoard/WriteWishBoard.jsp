...
<html>
	<head>
		...
		<link href="../CSS/WriteWishBoard.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div class="wrap">
            <header class="app-header"> <!-- div태그를 써서 작성하여도 되지만 헤더를 이용하여 좀더 세세히 나눔 -->
                <h1 class="brand">
                <a href="../Main/First-web.jsp" target="_blank"> 
           	...
           	<div class="writeFreeBoard-main">
           		<div class="writeBoard">
           			<form method="post" id="authForm" action="insertWishBoard.jsp">
							...
							<div class="box_FreeWrite">
								<div class="inp_Title">
									<span class = "boderTitle">
										...
										<input type="text" id="writeTitle" name="wish_Title" placeholder="Title">
								</div>
							</div>
						</div>
						...
						<div class="fieldset_two">
							<div class="box_FreeWrite">
								...
								<div class="inp_Content">
									<textarea id="writeContent" name="wish_Content" cols="10" rows="8"></textarea>
								</div>
							</div>
						</div>

						<!-- ****** 이름과 비밀번호 데리고 다니기 ****** -->
						<input type="hidden" name="Student_number" value= "<%=request.getParameter("Student_number")%>">
						...
						<div class="fieldset_three">
							...
							<button type="button" class="btn_Back" onClick="javascript:history.go(-1); return false ;" >돌아 가기</button>
						</div>
           			</form>
